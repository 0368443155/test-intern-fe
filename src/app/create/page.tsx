...
        <div>
          <label htmlFor="imageUrl" className="block text-sm font-medium text-gray-700">1. Image URL (website link)</label>
          <input
            id="imageUrl"
            name="imageUrl"
            type="url"
...
            placeholder="Paste link here (e.g., https://picsum.photos/400/300)"
...
        <div>
          <label htmlFor="imageFile" className="block text-sm font-medium text-gray-700">2. Upload from device</label>
          <input
            id="imageFile"
            name="imageFile"
            type="file" 
...
        
        ...
        {formData.imageUrl && (
            <div>
                ...
                <div className="relative w-full bg-gray-100 border border-gray-200 rounded-lg overflow-hidden" style={{ paddingTop: '56.25%' }}> {/* 16:9 Aspect Ratio */}
                    <Image
...
            onChange={handleTextChange} 
            placeholder="e.g., modern, simple, vibrant"
            className="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm p-2 text-gray-900" 
            disabled={isSubmitting}
          />
        </div>
